(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://jazzex.github.io/dendron/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://jazzex.github.io/dendron/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://jazzex.github.io/dendron/assets/css/just-the-docs-' + theme + ".css"
      );
    };
